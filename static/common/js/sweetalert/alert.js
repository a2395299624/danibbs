...
let m_alert = {
    ...
    */
    ...
    /*
          ...
          参数：
              - msg：提示的内容（可选）
      */
    'alertErrorTitle': function (title, msg) {
    ...
    */
    ...
    /*
        ...
        参数：无
    */
    'alertNetworkError': function (time) {
        this.alertErrorToast('网络错误', time);
    },
    /*
        功能：信息toast提示（1s后消失）
        参数：
            - msg：提示消息
    */
    'alertInfoToast': function (msg, time) {
        this.alertToast(msg, 'info', time);
    },
    /*
        功能：错误toast提示（1s后消失）
        参数：
            - msg：提示消息
    */
    'alertErrorToast': function (msg, time) {
        this.alertToast(msg, 'error', time);
    },
    /*
        功能：成功toast提示（1s后消失）
        参数：
            - msg：提示消息
    */
    'alertSuccessToast': function (msg, time) {
        if (!msg) {
            msg = '成功！';
        }
        this.alertToast(msg, 'success', time);
    },
    /*
        功能：弹出toast（1s后消失）
        参数：
            ...
            - type：toast的类型
    */
    'alertToast': function (msg, type, time) {
        swal({
            'title': msg,
            'text': '',
            'type': type,
