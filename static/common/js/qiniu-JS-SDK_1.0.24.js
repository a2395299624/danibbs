!function (e) {
        ...
        !function (e, t) {
            ...
            n("moxie/core/utils/Basic", [], function () {
                ...
                return o.OS = o.os, s && (o.debug = {runtime: !0, events: !1}, o.log = function () {
                    var t = arguments[0];
                    if ("string" === e.typeOf(t) && (t = e.sprintf.apply(this, arguments)), window && window.console && window.console.log); else if (document) {
    ...
    !function (global) {
        ...
        function QiniuJsSDK() {
            function log(e, t) {
                for (var i = "[qiniu-js-sdk][" + e + "]", n = i, r = 0; r < t.length; r++) "string" == typeof t[r] ? n += " " + t[r] : n += " " + that.stringifyJSON(t[r]), document.getElementById("qiniu-js-sdk-log") && (document.getElementById("qiniu-js-sdk-log").innerHTML += "<p>" + n + "</p>")
            }
